...
TEST_F(TestSmithWaterman, TestCalculation1) {
    ...
    string correct_res = sequentialSmithWaterman(
    ...
    ASSERT_EQ(master_service_->max_score_, 12);
    ASSERT_EQ(correct_res, master_service_->result_);
...
TEST_F(TestSmithWaterman, TestCalculation2) {
    ...
    ASSERT_EQ(master_service_->max_score_, 13);
    ASSERT_EQ(correct_res, master_service_->result_);
